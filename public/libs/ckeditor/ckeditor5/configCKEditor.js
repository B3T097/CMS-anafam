// Presta especial atención a ctrl + f5 para cada modificación
CKEDITOR.editorConfig = function (config) {
	config.allowedContent = true;
	config.contentsCss = ['assets/plugins/ckeditor5/content.css?v=214', 'assets/plugins/ckeditor5/notas.css?v=214', 'assets/plugins/ckeditor5/style.css?v=214'];
