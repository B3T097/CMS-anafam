            ...
            <div class="row mt-2">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="grado_academico" name="grado_academico" type="text" required>
                    </div>
                </div>
                <div class="col-md-6 col-sm-12">
                    <div class="mb-3">
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="facebook" name="facebook" aria-describedby="url-facebook legend-facebook" required>
                        </div>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="linkedin" name="linkedin" aria-describedby="url-linkedin legend-linkedin" required>
                        </div>
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="twitter" name="twitter" placeholder="Username" required>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="mb-3">
